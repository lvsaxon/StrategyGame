...
public class GeroBeam : MonoBehaviour {
	...
	void Update () {
		...
		gameObject.GetComponent<Renderer>().material.SetFloat("_AddTex",Time.frameCount*-0.05f*BP.AnimationSpd*10);
		gameObject.GetComponent<Renderer>().material.SetFloat("_BeamLength",NowLength);
